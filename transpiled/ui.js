...
var UIContext = _react2.default.createContext({});
...
function ui(key) {
  ...
  var connector = (0, _reactRedux.connect)(function (state) {
    return { ui: (0, _utils.getUIState)(state), globalState: state };
  }, function (dispatch) {
  ...
  return function (WrappedComponent) {
    ...
    _temp = _class = function (_Component) {
      ...
      function UI(props, ctx) {
        ...
        var _this = _possibleConstructorReturn(this, (UI.__proto__ || Object.getPrototypeOf(UI)).call(this, props, ctx));
      ...
      _createClass(UI, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
          ...
          var ui = (0, _utils.getUIState)(this.props.globalState);
        ...
        key: 'getConsumerValues',
        value: function getConsumerValues() {
        ...
        value: function render() {
          return _react2.default.createElement(
            UIContext.Provider,
            { value: this.getConsumerValues.call(this) },
      ...
      return UI;
    }(_react.Component), _class.contextType = UIContext, _class.propTypes = {
